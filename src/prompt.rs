...
pub const RESEARCH_WORKER_SYSTEM_PROMPT: &str = include_str!("../assets/prompts/research.md");
pub const EDIT_WORKER_SYSTEM_PROMPT: &str = include_str!("../assets/prompts/edit.md");
pub const REVIEW_WORKER_SYSTEM_PROMPT: &str = include_str!("../assets/prompts/review.md");
pub const TEST_WORKER_SYSTEM_PROMPT: &str = include_str!("../assets/prompts/test.md");
pub const PLAN_WORKER_SYSTEM_PROMPT: &str = include_str!("../assets/prompts/plan.md");
pub const EXECUTE_WORKER_SYSTEM_PROMPT: &str = include_str!("../assets/prompts/execute.md");
pub const DEFAULT_WORKER_SYSTEM_PROMPT: &str = include_str!("../assets/prompts/default.md");
